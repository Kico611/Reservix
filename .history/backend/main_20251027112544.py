...
def posalji_tekst_poruku(broj, poruka):
    ...
    if not broj_ispravan:
        print("[DEBUG] Broj nije ispravan:", broj)
        return False
    ...
    try:
        ...
        # --- ISPIS ZA DEBUG, uvijek ---
        print("[DEBUG] Poslani payload:", payload)
        print("[DEBUG] Status:", res.status)
        print("[DEBUG] Response body:", data.decode())

        # vrati True samo ako je status OK
