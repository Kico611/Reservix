...
def mark_reservation_cancelled(salon_id, rezervirao, od, do, datum):
    try:
        ...
        if user_phone:
            ...
            try:
                ...
                if not whatsapp_sent:
                    whatsapp_error = "WhatsApp poruka nije poslana ili broj neispravan"
            except Exception as e:
                whatsapp_sent = False
        ...
        whatsapp_sent = posalji_tekst_poruku(broj, poruka)
        return {
            "success": result.get("cancelled", False) and whatsapp_sent,  # success = True samo ako je i poruka poslana
