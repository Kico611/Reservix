...
export default function Home() {
  ...
  // Hook sada prima weekStart i filtrira termine
  const { weekSchedule, dayTimes, intervals } = useWeekSchedule(salon?.terms || [], weekStart);

  console.log("dayTimes prije ScheduleTable:", dayTimes);
  console.log("weekSchedule prije ScheduleTable:", weekSchedule);
  ...
  return (
    <div className="main-content">
      <WeekNavigator label={weekStart.toDateString()} onPrev={prevWeek} onNext={nextWeek} />
      {windowWidth > 768 && (
